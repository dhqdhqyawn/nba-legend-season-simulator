import { startBattleRoom } from "../../../../_lib/battle-rooms.mjs";
import {
...
async function handlePost(context) {
  ...
  const submission = normalizeRoomStartSubmission(await parseRoomJson(context.request));
  const room = await startBattleRoom(
    database,
    context.params?.code,
    submission,
