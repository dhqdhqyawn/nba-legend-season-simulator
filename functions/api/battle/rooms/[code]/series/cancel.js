import { cancelBattleRoomStrategySeries } from "../../../../../_lib/battle-room-strategy-series.mjs";
import { normalizeStrategyRoomAction } from "../../../../../_lib/battle-room-strategy-validation.mjs";
...
async function handlePost(context) {
  ...
  const snapshot = await cancelBattleRoomStrategySeries(
    requireDatabase(context.env),
    context.params?.code,
    normalizeStrategyRoomAction(await parseRoomJson(context.request)),
