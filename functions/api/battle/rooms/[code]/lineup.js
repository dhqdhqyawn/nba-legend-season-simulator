import { submitBattleRoomLineup } from "../../../../_lib/battle-rooms.mjs";
import {
...
async function handlePost(context) {
  ...
  const submission = normalizeRoomLineupSubmission(await parseRoomJson(context.request));
  const room = await submitBattleRoomLineup(
    database,
    context.params?.code,
    submission,
