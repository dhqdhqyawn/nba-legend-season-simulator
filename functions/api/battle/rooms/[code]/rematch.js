import { requestBattleRoomRematch } from "../../../../_lib/battle-rooms.mjs";
import {
...
async function handlePost(context) {
  ...
  const submission = normalizeRoomRematchSubmission(await parseRoomJson(context.request));
  const room = await requestBattleRoomRematch(
    database,
    context.params?.code,
    submission,
